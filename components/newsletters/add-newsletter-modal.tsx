...
import { generateNewsletterFields, type GeneratedNewsletter } from "@/app/actions/generate-newsletter"
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
      ...
      <div className="relative z-10 w-full max-w-2xl rounded-2xl border border-border bg-card shadow-2xl">
        ...
        <div className="flex items-center justify-between border-b border-border px-6 py-4">
          <h2 className="text-lg font-semibold text-foreground">Add Newsletter</h2>
          <button
            onClick={onClose}
          ...
          <div className="flex flex-col items-center justify-center gap-4 px-6 py-14 text-center">
            ...
            <div>
              ...
              <p className="mt-1 text-sm text-muted-foreground max-w-xs">
                Custom newsletters are available on the Pro plan. Upgrade to create newsletters tailored to any topic.
              </p>
            </div>
            <button
              onClick={onClose}
          ...
          {tab === "ai" ? (
            <div className="space-y-4">
              <p className="text-sm text-muted-foreground">
                Describe the newsletter you want and AI will configure everything for you.
              </p>
              <textarea
                value={prompt}
            ...
            <div className="space-y-5">
                    ...
                    <button
                      ...
                      onClick={() =>
                        setForm((s) => ({
                          ...s,
                          frequency: f,
                          scheduleDays: f === "daily" ? [] : s.scheduleDays.length > 0 ? [s.scheduleDays[0]] : ["monday"],
                        }))
                      }
              ...
              {form.frequency === "weekly" && (
                <div>
                  <label className="mb-1.5 block text-sm font-medium text-foreground">Delivery Day</label>
