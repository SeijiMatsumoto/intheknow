...
function CategoryIcon({ categoryId, className }: { categoryId: string | null; className?: string }) {
                ...
                <div className="flex items-center gap-3">
                  ...
                  {plan === "free" && (
                    <p className="text-sm text-muted-foreground">
                      Upgrade to Pro to unlock custom newsletters, delivery scheduling, and more.
                    </p>
                  )}
                  {(plan === "pro" || plan === "admin") && (
                    <p className="text-sm text-muted-foreground">
                ...
                {subscriptions.length === 0 ? (
                  ...
                  <ul className="divide-y divide-border">
                    {subscriptions.map((sub) => (
                      <li key={sub.id} className="flex items-center justify-between py-3 gap-4">
                        <div className="flex items-center gap-3 min-w-0">
                          <div className="flex h-8 w-8 shrink-0 items-center justify-center rounded-lg bg-accent/10 text-accent">
                            <CategoryIcon categoryId={sub.newsletterCategoryId} className="h-4 w-4" />
                          </div>
